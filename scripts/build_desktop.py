...
def main():
    ...
    for name in ("RELEASE.md", "SECURITY_FIXES_1.2.md", "RELIABILITY_1.2.1.md", "VERIFICATION_1.2.2.md", "APPEARANCE_1.3.0.md", "RECOVERY_1.4.0.md", "RELIABILITY_1.4.1.md", "GIF_1.5.0.md", "RELIABILITY_1.5.1.md", "MULTIFILE_1.6.0.md"):
