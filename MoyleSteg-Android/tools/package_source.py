...
PUBLIC_DOCS = {
    ...
    'RELIABILITY_0_1_1.md', 'SOURCES.md', 'DOWNLOAD_RESTORE_0_3_2.md', 'MULTIFILE_0_4_0.md',
    'RELIABILITY_0_4_1.md',
}
PUBLIC_EVIDENCE = {
    ...
    'TEST_REPORT_0_4_0.md', '0.4.0-alpha/validation.json',
    'TEST_REPORT_0_4_1.md', '0.4.1-alpha/validation.json',
    '0.4.1-alpha/cross-end-envelope-summary.json', '0.4.1-alpha/reference-envelope-verification.json',
    '0.4.0-alpha/cross-end-envelope-summary.json', '0.4.0-alpha/reference-envelope-verification.json',
